...
export default function InvoicePDF({ data, statusHistory }) {
      ...
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          ...
          <View style={{ alignItems: 'right', flexDirection: 'column' }}>
            <Text style={styles.h3}>{statusHistory?.currentStatus}</Text>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>Sunflower Enclaves</Text>
            <Text style={styles.body1}>D401, TP85, Canal Road</Text>
            <Text style={styles.body1}>Sarkhej, Ahmedabad - 380055</Text>
            <Text style={styles.body1}>Gujarat, India</Text>
            <Text style={styles.body1}>+91 8799089957</Text>
          ...
          <View style={styles.tableBody}>
            {data?.items?.map((item, index) => (
              <View style={styles.tableRow} key={item.id}>
                ...
                <View style={[styles.tableCell_3, styles.alignRight]}>
                  <Text>{fCurrency(item.priceSale * item.quantity)}</Text>
                </View>
              </View>
            ))}
