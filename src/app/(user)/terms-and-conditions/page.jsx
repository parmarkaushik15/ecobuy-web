  ...
  return (
    <>
      ...
      <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Ecobuy if
        ...
        <Typography variant="body1" paragraph>
          Unless otherwise stated, Ecobuy and/or its licensors own the intellectual property rights for all material on
          Ecobuy. All intellectual property rights are reserved. You may access this from Ecobuy for your own personal
        ...
        <Typography variant="body1" paragraph>
          ...
          certain areas of the website. Ecobuy does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of Ecobuy, its agents, and/or affiliates.
